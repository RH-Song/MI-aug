...
import sys
sys.path.append("..")
from cfg_relate._internally_replaced_utils import load_state_dict_from_url
from cfg_relate.misc import ConvNormActivation
from cfg_relate.utils import _log_api_usage_once
...
class VisionTransformer(nn.Module):
    ...
    def _process_input(self, x: torch.Tensor) -> torch.Tensor:
        ...
        torch._assert(h == 12, "Wrong image height!")
...
def _vision_transformer(
    ...
    **kwargs: Any,
    ...
    image_size = kwargs.pop("image_size", 1200)
